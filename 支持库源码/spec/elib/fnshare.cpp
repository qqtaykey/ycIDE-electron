...
INT_PTR __stdcall NotifySys(INT nMsg, DWORD_PTR dwParam1, DWORD_PTR dwParam2)
{
    INT_PTR ret = 0;
...
INT_PTR __stdcall ProcessNotifyLib(INT nMsg, DWORD_PTR dwParam1, DWORD_PTR dwParam2)
{
    INT_PTR nRet = NR_OK;
    switch (nMsg)
    {
